...
Meta context (правила/описание раздела, если найдено):
{meta_context}
...
1) Краткая генеративная подводка (2-4 предложения): что найдено и почему это релевантно запросу.
2) Раздел "Релевантные уроки" с пунктами:
   - краткий текст урока/фрагмента
   - практический смысл для запроса

Пиши строго по найденным материалам.
""",
    "document": """Роль:
Ты готовишь служебный текст для дальнейшего переноса в СЭД/внутренний документ.
